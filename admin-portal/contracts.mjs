...
export const ACTIONS = {
  ...
  approve_merchant: command(
    "Verify & Approve Merchant",
    "merchants",
    [...ops, "security_admin"],
    ["in_review", "not_registered"],
    "The merchant becomes verified and active. Selling eligibility and catalogue features are immediately enabled.",
